...
describe('Daily Challenge - Game Logic', () => {
  const mockStreets: Street[] = [
    ...
    { id: '13', name: 'La Rambla', tier: 1, geometry: [[]] },
    { id: '14', name: 'Gran Via de les Corts', tier: 1, geometry: [[]] },
    { id: '4', name: 'Carrer de Aragó', tier: 2, geometry: [[]] },
    { id: '5', name: 'Carrer de València', tier: 2, geometry: [[]] },
    { id: '6', name: 'Gran Via', tier: 2, geometry: [[]] },
    { id: '15', name: 'Avinguda Meridiana', tier: 2, geometry: [[]] },
    { id: '16', name: 'Passeig de Maragall', tier: 2, geometry: [[]] },
    { id: '7', name: 'Ronda de Sant Pere', tier: 3, geometry: [[]] },
    { id: '8', name: 'Carrer de Provença', tier: 3, geometry: [[]] },
    { id: '17', name: 'Carrer de Sicília', tier: 3, geometry: [[]] },
    { id: '18', name: 'Carrer de Padilla', tier: 3, geometry: [[]] },
    ...
    { id: '19', name: 'Carrer de Nàpols', tier: 4, geometry: [[]] },
    { id: '20', name: 'Carrer de Sardenya', tier: 4, geometry: [[]] },
  ];
