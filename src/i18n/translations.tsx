...
const translations: Translations = {
  en: {
    ...
    gentriRankGuiri: '📸 Instagram Tourist',
    gentriRankExpat: '🧳 Gràcia Expat',
    gentriRankNomad: '💻 Digital Nomad',
    gentriRankLandlord: '🏠 Rental Landlord',
    gentriRankSpeculador: '📈 Real Estate Speculator',
    gentriRankVei: '🏆 Local Lifer',
    scoreLabel: 'Score',
  ...
  es: {
    ...
    gentriRankGuiri: '📸 Guiri de Instagram',
    gentriRankExpat: '🧳 Expat de Gràcia',
    gentriRankNomad: '💻 Nómada Digital',
    gentriRankLandlord: '🏠 Casero',
    gentriRankSpeculador: '📈 Especulador Inmobiliario',
    gentriRankVei: '🏆 Vecino de Toda la Vida',
  ...
  ca: {
    ...
    gentriRankGuiri: "📸 Guiri d'Instagram",
    gentriRankExpat: '🧳 Expat de Gràcia',
    gentriRankNomad: '💻 Nòmada Digital',
    gentriRankLandlord: '🏠 Landlord Immobiliari',
    gentriRankSpeculador: '📈 Especulador Immobiliari',
    gentriRankVei: '🏆 Veí de Tota la Vida',
