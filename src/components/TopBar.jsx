        ...
        <>
            ...
            `}>
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <button
                        onClick={toggleTheme}
                        className={`p-1.5 md:p-2 rounded-full transition-colors ${theme === 'dark' ? 'bg-slate-800 text-yellow-500 hover:bg-slate-700' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
                        title="Toggle Theme"
                    >
                        {theme === 'dark' ? (
