...
describe('QuizInterface Component', () => {
    ...
    describe('Answer Selection', () => {
        ...
        it('should allow selecting different options', async () => {
            ...
            renderWithTheme(
                <QuizInterface {...defaultProps} onSelectOption={onSelectOption} />
            );
    ...
    describe('Hint System', () => {
        it('should reveal first hint when Reveal Hint is clicked', async () => {
            ...
            renderWithTheme(
                <QuizInterface {...defaultProps} onHintReveal={onHintReveal} />
            );
    ...
    describe('Feedback Display', () => {
        it('should disable all options when feedback is transitioning', () => {
            ...
            const buttons = screen.getAllByRole('button').filter(btn =>
                mockOptions.some(opt => btn.textContent.includes(opt.name))
            );
        ...
        it('should call onNext when Next button is clicked', async () => {
            ...
            renderWithTheme(
                <QuizInterface {...defaultProps} feedback="transitioning" onNext={onNext} />
            );
