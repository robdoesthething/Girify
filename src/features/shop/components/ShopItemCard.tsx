      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center text-center mb-3 min-h-0">
          <div
            ...
            className={`w-16 h-16 mb-3 flex items-center justify-center text-3xl relative overflow-hidden shrink-0 rounded-2xl bg-transparent ${activeTab === 'titles' ? 'cursor-pointer hover:scale-105 transition-transform shadow-md' : ''}`}
            style={{ imageRendering: 'pixelated' }}
          >
            {renderItemIcon()}
          </div>
