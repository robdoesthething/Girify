...
export const GAME = {
  ...
  TIME_DECAY_RATE: 15, // seconds after which bonus reaches 0

  // Scoring (scaled to 0-100 per question, 0-1000 total for 10 questions)
  POINTS: {
    CORRECT_BASE: 400, // Base points (scaled to 40 per question)
    TIME_BONUS_MAX: 600, // Max time bonus (scaled to 60 per question)
