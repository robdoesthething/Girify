export const initialState = {
    ...
    username: typeof localStorage !== 'undefined' ? localStorage.getItem('girify_username') || '' : '',
    quizStreets: [],
    currentQuestionIndex: 0,
    score: 0,
    feedback: 'idle', // 'idle' | 'transitioning'
    options: [],
    autoAdvance: typeof localStorage !== 'undefined' ? localStorage.getItem('girify_auto_advance') !== 'false' : true,
    hintStreets: [],
